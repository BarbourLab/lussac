...
def plot_sliders(fig: go.Figure, traces_per_plot: int, labels: npt.ArrayLike, filepath: str, args: dict | None = None, plots_per_file: int = 30) -> None:
	"""
...
def plot_units(wvf_extractor: si.WaveformExtractor, filepath: str, n_channels: int = 3, max_time_ms: float = 35., bin_size_ms: float = 0.25,
	...
	plot_sliders(fig, 3 + n_channels, labels=wvf_extractor.unit_ids, filepath=filepath)
